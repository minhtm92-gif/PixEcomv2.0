...
export interface MockStoreConfig {
  ...
  policies: { shipping: string; returns: string; privacy: string; terms: string; sellerAgreement: string };
}
...
export const STORE_CONFIG: MockStoreConfig = {
  ...
  policies: {
    ...
    sellerAgreement: `**Seller Agreement**\n\nThis Seller Agreement ("Agreement") governs your use of the PixEcom platform as a seller. By registering as a seller, you agree to the following terms and conditions.\n\n**1. Eligibility**\n\nYou must be at least 18 years old and legally capable of entering into binding contracts. You are responsible for ensuring that your business complies with all applicable laws and regulations in your jurisdiction.\n\n**2. Seller Obligations**\n\nAs a seller on the platform, you agree to:\n- Provide accurate and truthful product descriptions, images, and pricing\n- Ship products within the stated processing time\n- Respond to customer inquiries within 48 hours\n- Comply with all applicable consumer protection laws\n- Not sell prohibited, counterfeit, or infringing products\n\n**3. Fees and Payments**\n\nPixEcom charges a platform fee on each successful transaction. Current fee rates are available in your seller dashboard. Payments are processed and disbursed according to the payment schedule outlined in your seller settings. PixEcom reserves the right to adjust fees with 30 days' notice.\n\n**4. Product Listings**\n\nAll product listings must be accurate and not misleading. PixEcom reserves the right to remove any listing that violates our policies, infringes on intellectual property rights, or is deemed inappropriate. Sellers are solely responsible for the legality and quality of their products.\n\n**5. Shipping and Fulfillment**\n\nSellers must ship orders within the processing time stated in their store settings. Valid tracking information must be provided for all shipments. Failure to fulfill orders in a timely manner may result in account suspension.\n\n**6. Returns and Refunds**\n\nSellers must honor their stated return policy. In cases of disputes, PixEcom may mediate and issue refunds at its discretion. Sellers are responsible for return shipping costs unless otherwise agreed.\n\n**7. Intellectual Property**\n\nSellers warrant that they own or have proper licenses for all content uploaded to the platform, including product images, descriptions, and trademarks. PixEcom is not responsible for intellectual property disputes between sellers and third parties.\n\n**8. Account Suspension and Termination**\n\nPixEcom reserves the right to suspend or terminate seller accounts for violations of this Agreement, excessive customer complaints, suspected fraud, or any activity that harms the platform or its users. Sellers may terminate their account at any time with 30 days' written notice.\n\n**9. Limitation of Liability**\n\nPixEcom provides the platform "as is" and is not liable for any indirect, incidental, or consequential damages arising from your use of the platform. Our total liability shall not exceed the fees paid by you in the 12 months preceding the claim.\n\n**10. Governing Law**\n\nThis Agreement shall be governed by and construed in accordance with the laws of the State of Delaware, United States.\n\n**11. Changes to this Agreement**\n\nPixEcom may update this Agreement at any time. Sellers will be notified of material changes via email or platform notification. Continued use of the platform after changes constitutes acceptance.\n\nFor questions about this Agreement, contact sellers@pixelxlab.com.`,
  },
};
